...
#'@export bayes.rej the existences of causal effect between the latent exposure and the outcome
#'@export bayes.sign the the direction of the significant causal effect. 0 means no causal effect.
#'@export par posterior samples generated by the Gibbs sampling using an MCMC algorithm
#'@export ci 95% credible intervals for model parameters after dropping the burnin period.
